/*
  # Initial and complete threshold configuration for energy monitoring system
  ...
  2. Initial Thresholds
    ...
    - Voltage thresholds (critical/warning, low/high)
    - Power thresholds (critical/warning, high only)
