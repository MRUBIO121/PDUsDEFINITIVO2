-- ============================================================================================================
-- ARCHIVO: 20251022120000_create_usersAlertado_table.sql
-- PROPOSITO: Crear tabla usersAlertado para el sistema de autenticación
-- FECHA: 2025-10-22
-- VERSION: 1.0
-- ============================================================================================================
--
-- Este script crea la tabla usersAlertado con soporte para 4 roles diferentes:
...
--
-- TABLA INCLUIDA:
--   1. usersAlertado - Usuarios del sistema con contraseñas hasheadas y roles
--
-- ============================================================================================================
...
PRINT '';
PRINT '============================================================================================================';
PRINT 'INICIO: Creación de tabla usersAlertado';
PRINT '============================================================================================================';
PRINT '';
...
BEGIN
    CREATE TABLE dbo.usersAlertado (
    ...
    CREATE INDEX IX_usersAlertado_usuario ON dbo.usersAlertado(usuario);
    CREATE INDEX IX_usersAlertado_rol ON dbo.usersAlertado(rol);
    CREATE INDEX IX_usersAlertado_activo ON dbo.usersAlertado(activo);
...
IF NOT EXISTS (SELECT * FROM dbo.usersAlertado WHERE usuario = 'admin')
BEGIN
    ...
    INSERT INTO dbo.usersAlertado (usuario, password_hash, rol, activo, fecha_creacion, fecha_modificacion)
    VALUES (
        'admin',
...
SELECT COUNT(*) as Total_Usuarios FROM dbo.usersAlertado;
SELECT usuario, rol, activo, fecha_creacion FROM dbo.usersAlertado;

PRINT '';
PRINT '============================================================================================================';
PRINT '✅ Setup de tabla usersAlertado FINALIZADO EXITOSAMENTE';
PRINT '============================================================================================================';
PRINT '';
